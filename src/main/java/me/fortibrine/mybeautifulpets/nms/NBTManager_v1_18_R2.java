...
import net.minecraft.server.v1_18_R2.EntityLiving;
import net.minecraft.server.v1_18_R2.NBTBase;
import net.minecraft.server.v1_18_R2.NBTTagCompound;
...
public class NBTManager_v1_18_R2 implements NBTManager {
